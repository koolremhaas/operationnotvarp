    ...
    <header className="border-b border-border bg-card relative">
      ...
      <div className="relative flex items-center justify-between px-6 py-3">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-7 h-7 border border-primary/50 flex items-center justify-center opacity-60 group-hover:opacity-90 transition-opacity">
          ...
          <div>
            ...
            <p className="text-[9px] text-muted-foreground tracking-[0.15em] mt-0.5 opacity-50">
